...
/*   Updated: 2023/03/23 14:06:00 by buozdemi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	FragTrap unnamed_class;
	std::cout << "(Name must be unnamed+FragTrap) -> " << unnamed_class.getName() << std::endl;
